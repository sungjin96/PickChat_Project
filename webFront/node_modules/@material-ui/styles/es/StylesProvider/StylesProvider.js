...
function StylesProvider(props) {
  ...
  process.env.NODE_ENV !== "production" ? warning(!context.jss.options.insertionPoint || !localOptions.jss, 'Material-UI: you cannot use the jss and injectFirst props at the same time.') : void 0;
