...
var List = _react.default.forwardRef(function List(props, ref) {
  ...
  return _react.default.createElement(_ListContext.default.Provider, {
    ...
    className: (0, _clsx2.default)(classes.root, (_clsx = {}, (0, _defineProperty2.default)(_clsx, classes.dense, dense), (0, _defineProperty2.default)(_clsx, classes.padding, !disablePadding), (0, _defineProperty2.default)(_clsx, classes.subheader, subheader), _clsx), className),
    ref: ref
