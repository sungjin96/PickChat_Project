...
var Badge = React.forwardRef(function Badge(props, ref) {
  ...
  return React.createElement(ComponentProp, _extends({
    ...
    className: clsx(classes.badge, (_clsx = {}, _defineProperty(_clsx, classes["color".concat(capitalize(color))], color !== 'default'), _defineProperty(_clsx, classes.invisible, invisible), _defineProperty(_clsx, classes.dot, variant === 'dot'), _clsx))
  }, displayValue));
});
