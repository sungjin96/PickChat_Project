...
public class HWJ_MyTypeAdapter extends RecyclerView.Adapter<HWJ_MyTypeAdapter.ViewHolder> {
    Context context;
    List<HWJ_TypeVO> array;

    public HWJ_MyTypeAdapter(Context context, List<HWJ_TypeVO> array) {
