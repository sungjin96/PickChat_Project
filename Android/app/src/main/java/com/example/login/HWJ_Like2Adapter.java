...
public class HWJ_Like2Adapter extends RecyclerView.Adapter<HWJ_Like2Adapter.ViewHolder> {
    Context context;
    List<HWJ_LikeVO> array;

    public HWJ_Like2Adapter(Context context, List<HWJ_LikeVO> array) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_hwj_like2, parent, false);
