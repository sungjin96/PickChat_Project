...
public class type_categoryAdapter extends RecyclerView.Adapter<type_categoryAdapter.ViewHolder> {
    Context context;
    List<type_categoryVO> array;
    type_categoryVO vo;
    int count = 0;

    public type_categoryAdapter(Context context, List<type_categoryVO> array) {
