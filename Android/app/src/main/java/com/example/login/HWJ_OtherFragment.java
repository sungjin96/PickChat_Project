...
public class HWJ_OtherFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        //상대방 아이디 받아오는 구간
        TextView userfragment = getActivity().findViewById(R.id.userfragment);
        userid = userfragment.getText().toString();
    ...
    private void profileCall(){
        ...
        call.enqueue(new Callback<UserProfileVO>() {
            ...
            public void onResponse(Call<UserProfileVO> call, Response<UserProfileVO> response) {
                ...
                userjob.setText(vo_profile.getUserid().toString());
    ...
    private void myTypeCall(){
        Call<List<HWJ_TypeVO>> call = rs.listMytype(userid);
    ...
    private void hobbyCall(){
        Call<List<HWJ_HobbyVO>> call = rs.listUserhobby(userid);
    ...
    private void likeTypeCall(){
        Call<List<HWJ_TypeVO>> call = rs.listLiketype(userid);
        call.enqueue(new Callback<List<HWJ_TypeVO>>() {
            @Override
            public void onResponse(Call<List<HWJ_TypeVO>> call, Response<List<HWJ_TypeVO>> response) {
