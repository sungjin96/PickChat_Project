...
public class HWJ_Like1Fragment extends Fragment{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_hwj_like1, container, false);
        ...
        SharedPreferences sharedPreferences= this.getContext().getSharedPreferences("userid",MODE_PRIVATE);
    ...
    public void onResume() {
        super.onResume();
        Call<List<HWJ_LikeVO>> call = rs.listWhoLike(userid); //아이디 값 받아오는 구간
